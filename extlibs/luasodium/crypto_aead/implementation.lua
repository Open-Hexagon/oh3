    ...
    local function ls_crypto_aead(basename)
        ...
        return {
            ...
            [crypto_aead_encrypt] = function(k, m, npub, ad)
                ...
                sodium_lib[crypto_aead_encrypt](c, clen, m, mlen, ad, adlen, nil, npub, k)
            ...
            [crypto_aead_decrypt] = function(k, c, npub, ad)
                ...
                if tonumber(sodium_lib[crypto_aead_decrypt](m, mlen, nil, c, clen, ad, adlen, npub, k)) == -1 then
            ...
            [crypto_aead_encrypt_detached] = function(k, m, npub, ad)
                ...
                sodium_lib[crypto_aead_encrypt_detached](c, mac, maclen, m, mlen, ad, adlen, nil, npub, k)
            ...
            [crypto_aead_decrypt_detached] = function(k, c, mac, npub, ad)
                ...
                if
                    tonumber(sodium_lib[crypto_aead_decrypt_detached](m, nil, c, clen, mac, ad, adlen, npub, k)) == -1
                then
    ...
    local function ls_crypto_aead_precomp(basename)
        ...
        local M = {
            ...
            [crypto_aead_encrypt_afternm] = function(ls_state, m, npub, ad)
                ...
                local clen = ffi.new("size_t[1]")
                local c = char_array(mlen + ABYTES)
                sodium_lib[crypto_aead_encrypt_afternm](c, clen, m, mlen, ad, adlen, nil, npub, ls_state.state)
            ...
            [crypto_aead_decrypt_afternm] = function(ls_state, c, npub, ad)
                ...
                if
                    tonumber(
                        sodium_lib[crypto_aead_decrypt_afternm](m, mlen, nil, c, clen, ad, adlen, npub, ls_state.state)
                    ) == -1
                then
            ...
            [crypto_aead_encrypt_detached_afternm] = function(ls_state, m, npub, ad)
                ...
                local c = char_array(mlen)
                local mac = char_array(ABYTES)
                sodium_lib[crypto_aead_encrypt_detached_afternm](
                    c,
                    mac,
                    maclen,
                    m,
            ...
            [crypto_aead_decrypt_detached_afternm] = function(ls_state, c, mac, npub, ad)
                ...
                if
                    tonumber(
                        sodium_lib[crypto_aead_decrypt_detached_afternm](
                            m,
                            nil,
                            c,
                            clen,
