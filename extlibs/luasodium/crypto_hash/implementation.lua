    ...
    local function ls_crypto_hash(basename)
        ...
        return {
            [crypto_hash] = function(message)
                ...
                if tonumber(sodium_lib[crypto_hash](hash, message, string_len(message))) == -1 then
    ...
    local function ls_crypto_hash_state(basename)
        ...
        local M = {
            ...
            [crypto_hash_update] = function(ls_state, m)
                ...
                return tonumber(sodium_lib[crypto_hash_update](ls_state.state, m, string_len(m))) ~= -1
            end,
            ...
            [crypto_hash_final] = function(ls_state)
                ...
                if tonumber(sodium_lib[crypto_hash_final](ls_state.state, h)) == -1 then
