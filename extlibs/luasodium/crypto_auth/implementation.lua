    ...
    local function ls_crypto_auth(basename)
        ...
        return {
            [crypto_auth] = function(message, key)
                ...
                if tonumber(sodium_lib[crypto_auth](out, message, string_len(message), key)) == -1 then
            ...
            [crypto_auth_verify] = function(tag, message, key)
                ...
                return tonumber(sodium_lib[crypto_auth_verify](tag, message, string_len(message), key)) == 0
            end,
