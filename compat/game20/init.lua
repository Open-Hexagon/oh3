...
function public.update(frametime)
    ...
    input.update()
    local focus = input.get(config.get("key_focus"))
    local swap = input.get(config.get("key_swap"))
    local cw = input.get(config.get("key_right"))
    local ccw = input.get(config.get("key_left"))
