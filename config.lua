...
add_setting("player_speed", 9.45, false, { 192, 21 })
add_setting("player_focus_speed", 4.625, false, { 192, 21 })
add_setting("black_and_white", false, false, { 192, 21 })
add_setting("3D_enabled", true, false, { 192, 21 })
add_setting("3D_multiplier", 1, false, { 192, 21 })
add_setting("3D_max_depth", 100, false, { 192 })
add_setting("background", true, false, { 192, 21 })
add_setting("invincible", false, false, { 192, 21 })
add_setting("rotation", true, false, { 192, 21 })
add_setting("messages", true, false, { 192, 21 })
add_setting("key_focus", "lshift", true, { 192, 21 })
add_setting("key_right", "right", true, { 192, 21 })
add_setting("key_left", "left", true, { 192, 21 })
add_setting("key_swap", "space", true, 21)
add_setting("sync_music_to_dm", true, true, 21)
...
add_setting("flash", true, true, { 192, 21 })
